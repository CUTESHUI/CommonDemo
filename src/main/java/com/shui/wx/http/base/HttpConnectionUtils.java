package com.shui.wx.http.base;


import com.shui.wx.utils.common.CharsetCode;
import com.shui.wx.utils.common.CollectionUtils;
import com.shui.wx.utils.common.ObjectUtils;
...
public class HttpConnectionUtils extends BaseConnectionUtils {
    ...
    public static String soap12(String methodName, String wsdlLocation, String soapRequestData, String type) throws Exception {
        ...
        RequestEntity requestEntity = new InputStreamRequestEntity(inputStream, bytes.length, "application/soap+message; charset=utf-8");
