package com.shui.wx.http.handler.template.send;

import com.shui.wx.beans.json.template.WxTemplateId;
import com.shui.wx.beans.json.template.WxTemplateShortId;
