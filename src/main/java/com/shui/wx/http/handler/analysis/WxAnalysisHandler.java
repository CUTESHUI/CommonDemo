package com.shui.wx.http.handler.analysis;

import com.shui.wx.beans.json.analysis.req.WxAnalysisDate;
import com.shui.wx.beans.json.analysis.resp.api.WxAPISummaryAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.api.WxAPISummaryHourAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.article.summary.WxArticleSummaryAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.article.total.WxNewsArticleTotalAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.article.user.read.WxNewsUserReadAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.article.user.read.hour.WxNewsUserReadHourAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.article.user.share.WxNewsUserShareAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.article.user.share.hour.WxNewsUserShareHourAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.msg.upstream.WxMsgUpstreamAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.msg.upstream.dist.WxMsgUpstreamDistAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.msg.upstream.hour.WxMsgUpstreamHourAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.msg.upstream.month.WxMsgUpstreamMonthAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.news.msg.upstream.week.WxMsgUpstreamWeekAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.user.WxUserCumulateAnalysisResp;
import com.shui.wx.beans.json.analysis.resp.user.WxUserSummaryAnalysisResp;
