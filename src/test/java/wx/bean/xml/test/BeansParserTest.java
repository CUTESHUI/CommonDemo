package wx.bean.xml.test;

import com.shui.wx.beans.router.receive.WxReceiveRouterMessage;
import com.shui.wx.beans.xml.message.receive.event.mass.WxMassCopyrightCheckResult;
import com.shui.wx.beans.xml.message.receive.event.mass.WxMassEventMessage;
import com.shui.wx.beans.xml.message.receive.event.mass.WxMassResultListItem;
import com.shui.wx.beans.xml.message.receive.event.menu.WxMenuPicSysPhotoInfoMessage;
import com.shui.wx.beans.xml.message.receive.event.menu.WxMenuPicSysPhotoItemMessage;
import com.shui.wx.beans.xml.message.receive.event.menu.WxMenuPicSysPhotoMessage;
import com.shui.wx.beans.xml.message.receive.voice.WxReceiveVoiceMessage;
import com.shui.wx.beans.xml.message.send.news.WxSendNewsItemMessage;
import com.shui.wx.beans.xml.message.send.news.WxSendNewsMessage;
import com.shui.wx.constants.WxConstants;
import com.shui.wx.utils.crypt.wrapper.WxBizMsgCryptWrapper;
...
//        sb.append("</a>");
    ...
    public void testXML2WxMenuPic2(){
        String str = "<message><ToUserName><![CDATA[toUser]]></ToUserName><FromUserName><![CDATA[fromUser]]></FromUserName><CreateTime>1531969861648</CreateTime><MsgType><![CDATA[msgType]]></MsgType><Event><![CDATA[event]]></Event><EventKey><![CDATA[eventKey]]></EventKey><SendPicsInfo><Count>1</Count><PicList><item><PicMd5Sum><![CDATA[picMd5Sum]]></PicMd5Sum></item></PicList></SendPicsInfo></message>";
    ...
    public void testWxBizMsgCryptWrapper() throws Exception{
        ...
        String str = "<message><ToUserName><![CDATA[toUser]]></ToUserName><FromUserName><![CDATA[fromUser]]></FromUserName><CreateTime>1531969861648</CreateTime><MsgType><![CDATA[msgType]]></MsgType><Event><![CDATA[event]]></Event><EventKey><![CDATA[eventKey]]></EventKey><SendPicsInfo><Count>1</Count><PicList><item><PicMd5Sum><![CDATA[picMd5Sum]]></PicMd5Sum></item></PicList></SendPicsInfo></message>";
        //String str = "<message><ToUserName><![CDATA[toUser]]></ToUserName><FromUserName><![CDATA[fromUser]]></FromUserName><CreateTime>1531982446839</CreateTime><MsgType><![CDATA[news]]></MsgType><ArticleCount>2</ArticleCount><Articles><item><Title><![CDATA[title]]></Title><Description><![CDATA[description]]></Description><PicUrl><![CDATA[picUrl]]></PicUrl><Url><![CDATA[url]]></Url></item><item><Title><![CDATA[title]]></Title><Description><![CDATA[description]]></Description><PicUrl><![CDATA[picUrl]]></PicUrl><Url><![CDATA[url]]></Url></item></Articles></message>";
        log.info("原字符串：" + str);
